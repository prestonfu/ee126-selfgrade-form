  ...
  return (
    <div className={indexStyles.indexWrapper}>
      ...
      <div className={indexStyles.description}>
        To learn more about how self-grades work, check out <ExternalLink href="https://ee120-course-staff.github.io/policies/#self-grades">the course website</ExternalLink>
      </div>
